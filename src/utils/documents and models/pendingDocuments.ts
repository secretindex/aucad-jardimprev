...
Solteira - Certidão de nascimento`,
  ...
  "reg/n":
    "Comprovante do Registro Profissional para os servidores que ocupam os cargos de assistente social, engenheiro civil, dentista, farmacêutico, psicólogo, médico, fisioterapeuta, nutricionista, médico veterinário, técnico de enfermagem, fonoaudiólogo, procurador, farmacêutico/bioquímico, técnico em segurança do trabalho, enfermeiro",
  "dp/21":
