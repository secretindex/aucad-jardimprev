...
const invalidStandard: InvalidDocuments = {
  "cr/60": `Comprovante de residência emitido a partir de setembro deste ano;\nObs: Comprovante enviado foi emitido em MES. Favor, enviar um comprovante dentro do prazo acima`,
  "cr/n":
    "Comprovante de Residência atualizado (emitido a partir de setembro/2025) ou declaração conforme modelo que será disponibilizado no local do recadastramento",
  "cr/dsc":
...
Solteira - Certidão de nascimento`,
  ...
  "reg/n": "Comprovante do Registro Profissional para os servidores que ocupam os cargos de assistente social, engenheiro civil, dentista, farmacêutico, psicólogo, médico, fisioterapeuta, nutricionista, médico veterinário, técnico de enfermagem, fonoaudiólogo, procurador, farmacêutico/bioquímico, técnico em segurança do trabalho, enfermeiro",
  "dp/21":
    "Em caso de dependente filho(a) com mais de 21 anos, é necessário que se envie laudo/atestado médico caso declarado inválido. Caso não, remover como dependente previdenciário",
